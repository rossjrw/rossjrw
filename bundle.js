                ...
                case 2:
                    ...
                    if (state.possibleMoves) {
                        actions = Object.keys(state.possibleMoves)
                            ...
                            return {
                                text: Object(compress_tag__WEBPACK_IMPORTED_MODULE_2__["compress"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n          ", "\n          ", "\n          ", "\n          ", "\n          ", "\n          a ", "\n          ", "\n        "], ["\n          ", "\n          ", "\n          ", "\n          ", "\n          ", "\n          a ", "\n          ", "\n        "])), events.rosetteClaimed ? ":rosette:" : "", events.captureHappened ? ":crossed_swords:" : "", events.ascensionHappened ? ":rocket:" : "", events.gameWon ? ":crown:" : "", events.ascensionHappened ? "Ascend" : "Move", move.from === 0 ? "new piece" : "piece from tile " + move.from, events.ascensionHappened ? "" : "to tile " + move.to),
